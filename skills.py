...
# ============================================================================
# CATÁLOGO MASTER DE HABILIDADES - NEURAL FIGHTS
# ============================================================================
# Tipos disponíveis: PROJETIL, BUFF, AREA, DASH, SUMMON, BEAM
...
SKILL_DB = {
    ...
    # =========================================================================
    # 🔥 FOGO - Dano alto, efeitos de área
    # =========================================================================
    "Bola de Fogo": {
        "tipo": "PROJETIL",
        "dano": 18.0,
    ...
    # =========================================================================
    # ❄️ GELO - Controle, slow, dano moderado
    # =========================================================================
    "Estilhaço de Gelo": {
        "tipo": "PROJETIL",
        "dano": 8.0,
    ...
    "Prisão de Gelo": {
        ...
        "cooldown": 8.0,
        "efeito": "ATORDOAR",
        "descricao": "Aprisiona o alvo brevemente"
    },
    
    # =========================================================================
    # ⚡ RAIO - Velocidade extrema, dano médio
    # =========================================================================
    "Relâmpago": {
        "tipo": "BEAM",
        "dano": 11.0,
    ...
    # =========================================================================
    # ⚔️ FÍSICO/MARCIAL - Melees, dashes
    # =========================================================================
    "Impacto Sônico": {
        "tipo": "PROJETIL",
        "dano": 9.0,
        ...
        "cooldown": 3.0,
        "efeito": "EMPURRAO",
        "descricao": "Onda de choque curta mas poderosa"
    },
    "Avanço Brutal": {
        "tipo": "DASH",
        "dano": 12.0,
    ...
    # =========================================================================
    # 🛡️ DEFESA/SUPORTE - Buffs, cura, escudos
    # =========================================================================
    "Escudo Arcano": {
        "tipo": "BUFF",
        "cor": (100, 150, 255),
