...
if TYPE_CHECKING:
    ...
    class _AIBrainMixinBase:
        ...
        impulso: float
        congelamento: float
        memoria_adaptativa: dict[str, Any]
        memoria_oponente: dict[str, Any]
        ...
        def _decair_memoria_adaptativa(self, *args: Any, **kwargs: Any) -> Any: ...
        def _registrar_aprendizado_tatico(self, *args: Any, **kwargs: Any) -> Any: ...
        def _decair_memoria_curta_oponentes(self, *args: Any, **kwargs: Any) -> Any: ...
        def _registrar_aprendizado_oponente(self, *args: Any, **kwargs: Any) -> Any: ...
        def _registrar_padrao_oponente(self, *args: Any, **kwargs: Any) -> Any: ...
        def _obter_padrao_dominante_oponente(self, *args: Any, **kwargs: Any) -> Any: ...
