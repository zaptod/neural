...
class SimuladorEffects:
    """Mixin de efeitos visuais: partículas, trails, colisões, slow motion."""
    ...
    def _remover_trail_projetil(self, proj):
        ...
        if hasattr(self, 'magic_vfx') and self.magic_vfx:
            try:
                ...
                pass  # Trail pode não existir — sem problema
    ...
    def atualizar_rastros(self):
        for p in [self.p1, self.p2]:
            if p is None or p.morto: self.rastros[p] = []; continue
