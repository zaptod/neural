"""
NEURAL FIGHTS - MÃ³dulo Utils
FunÃ§Ãµes utilitÃ¡rias gerais e configuraÃ§Ãµes.
"""

import math
import random

# Re-exporta configuraÃ§Ãµes
...
def lerp(a, b, t):
    """InterpolaÃ§Ã£o linear entre a e b"""
    return a + (b - a) * t


def ease_out(t):
    """Easing function para animaÃ§Ãµes suaves"""
    return 1 - (1 - t) ** 2


def ease_in_out(t):
    """Easing function para inÃ­cio e fim suaves"""
    if t < 0.5:
        return 2 * t * t
    return 1 - (-2 * t + 2) ** 2 / 2
...
def random_range(min_val, max_val):
    """NÃºmero aleatÃ³rio entre min e max (float)"""
    return random.uniform(min_val, max_val)


def random_color_variation(base_color, variation=30):
    """Gera uma variaÃ§Ã£o de cor prÃ³xima Ã  cor base"""
...
def angle_between(x1, y1, x2, y2):
    """Ã‚ngulo entre dois pontos em graus"""
...
__all__ = [
    ...
    'normalize_vector',
    'rotate_point',
    # ConfiguraÃ§Ãµes - FÃ­sica
    'PPM', 'GRAVIDADE_Z', 'ATRITO', 'ALTURA_PADRAO',
    # ConfiguraÃ§Ãµes - Visual
    'LARGURA', 'ALTURA', 'FPS',
    # ConfiguraÃ§Ãµes - Cores
    'PRETO', 'BRANCO', 'CHAO_COR', 'COR_FUNDO', 'COR_GRID',
    'VERMELHO_SANGUE', 'SANGUE_ESCURO', 'AMARELO_FAISCA',
    'VERDE_VIDA', 'VERMELHO_VIDA', 'AZUL_MANA', 'COR_CORPO',
    'COR_P1', 'COR_P2', 'COR_UI_BG', 'COR_TEXTO_TITULO', 'COR_TEXTO_INFO',
