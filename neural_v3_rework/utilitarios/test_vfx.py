"""
NEURAL FIGHTS - Teste de Efeitos Visuais DramÃ¡ticos v11.0
=========================================================
    ...
    while running:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.button == 1:  # Esquerdo - explosÃ£o
        ...
        # Contadores
        count_txt = f"ExplosÃµes: {len(vfx.explosions)} | Beams: {len(vfx.beams)} | Auras: {len(vfx.auras)} | Summons: {len(vfx.summons)}"
