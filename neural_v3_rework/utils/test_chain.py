...
from core.hitbox import get_hitbox_profile, HITBOX_PROFILES
from effects.weapon_animations import WeaponAnimator
...
dados = Personagem('Test', 1.0, 5.0, 5.0, '', 0, 200, 50, 50, 'Guerreiro (Força Bruta)')
