...
class HitSpark:
    """Faíscas estilizadas de impacto — v15.0 POLISHED com glow"""
    def __init__(self, x, y, cor, direcao, intensidade=1.0):
        ...
        # Mais faíscas com variação maior
...
class Shockwave:
    """Onda de choque — v15.0 POLISHED com glow e gradiente"""
    ...
    def update(self, dt):
        self.vida -= dt
        self.raio += 450 * dt  # Expande um pouco mais rápido
...
class EncantamentoEffect:
    """Efeito visual de encantamento na arma — v15.0 com glow e padrões por elemento"""
    ...
    def update(self, dt):
        ...
        if self.timer > 0.04:  # Spawn mais frequente
            ...
            if pos:
                ...
                # Padrões de velocidade por elemento
    ...
    def draw(self, tela, cam):
        for p in self.particulas:
            ...
            if tam > 2:
                ...
                if self.encantamento in ["Relâmpago", "Sagrado", "Chamas"]:
