"""
NEURAL FIGHTS â€” nucleo/lutador/entity.py  [D03/D04 Sprint 8]
===========================================================
Lutador: classe principal, herda todos os mixins.

ContÃ©m apenas:
  - __init__ (inicializaÃ§Ã£o de todos os atributos)
  - update() (loop central)

Nota: AIBrain Ã© importado dentro de __init__ (import inline intencional)
para quebrar a dependÃªncia circular:
  ia/__init__ â†’ ia/brain â†’ nucleo/__init__ â†’ nucleo/entities â†’ nucleo/lutador/entity â†’ ai
"""
...
from utilitarios.config import PPM, ALTURA_PADRAO
...
# AIBrain Ã© importado dentro de __init__ para evitar importaÃ§Ã£o circular
...
class Lutador(StatsMixin, PhysicsMixin, CombatMixin, WeaponsMixin):
    ...
    [D03 Sprint 8] Dividida em 4 mixins:
        StatsMixin    â€” stats, skills, channeling        (~120 L)
        PhysicsMixin  â€” fÃ­sica, movimento, trail         (~220 L)
        CombatMixin   â€” dano, status, buffs, morte       (~430 L)
        WeaponsMixin  â€” ataques, skills, projÃ©teis       (~560 L)
    """
    ...
    def __init__(self, dados_char, pos_x, pos_y, team_id=0):
        ...
        # Dados da classe
        self.classe_nome = getattr(self.dados, 'classe', "Guerreiro (ForÃ§a Bruta)")
        ...
        # Sistema de prevenÃ§Ã£o de multi-hit v10.1
        self.ataque_id = 0
        self.alvos_atingidos_neste_ataque = set()

        # AnimaÃ§Ã£o de arma v2.0
    ...
    @property
    def ai(self):
        """Alias legado compatÃ­vel com o brain atual."""
        return self.brain
