"""
NEURAL FIGHTS â€” Skills: ðŸ”¥ FOGO
==================================
Dano alto, queimaduras, explosÃµes
...
SKILLS_FOGO = {
    ...
    "Chamas do DragÃ£o": {
        ...
        "descricao": "Sopro de fogo contÃ­nuo"
    },
    "CombustÃ£o EspontÃ¢nea": {
        "tipo": "PROJETIL", "dano": 80.0, "velocidade": 0.5, "raio": 0.3,  # B3 fix: era 0 â†’ projÃ©til ficava parado
    ...
    "ErupÃ§Ã£o VulcÃ¢nica": {
        ...
        "descricao": "Canaliza magma que erupciona em meteoros aleatÃ³rios"
    },
    "Escudo de Brasas": {
    ...
    "ExplosÃ£o Nova": {
        ...
        "descricao": "ExplosÃ£o ao redor do conjurador"
    },
    "FÃªnix": {
        ...
        "descricao": "Invoca uma fÃªnix que ataca com fogo e revive uma vez"
    },
    "Inferno": {
    ...
    "LanÃ§a de Fogo": {
        ...
        "efeito": "QUEIMANDO", "elemento": "FOGO",
        "descricao": "ProjÃ©til rÃ¡pido que causa queimadura"
    },
    "Meteoro": {
    ...
    "Pilar de Fogo": {
        ...
        "delay": 0.8, "duracao": 1.0, "descricao": "Pilar de fogo que lanÃ§a inimigos"
    },
    "Rastro de Fogo": {
