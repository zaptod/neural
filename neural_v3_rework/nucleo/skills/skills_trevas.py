"""
NEURAL FIGHTS â€” Skills: ðŸŒ‘ TREVAS
====================================
Drain, fear, debuffs, silÃªncio
...
SKILLS_TREVAS = {
    ...
    "Colheita de Almas": {
        ...
        "cura_por_morte": 50.0,
        "descricao": "Dano em Ã¡rea - cura massiva se matar"
    },
    "CÃ³pia Sombria": {
    ...
    "Eclipse": {
        ...
        "descricao": "Escurece uma Ã¡rea massiva cegando e drenando inimigos"
    },
    "Esfera Sombria": {
    ...
    "MaldiÃ§Ã£o": {
        ...
        "descricao": "MaldiÃ§Ã£o que enfraquece e causa DoT"
    },
    "Marca da Morte": {
        ...
        "descricao": "Marca o alvo que explode em trevas apÃ³s 3 segundos"
    },
    "Medo Profundo": {
        "tipo": "AREA", "dano": 0.0, "raio_area": 4.0, "cor": (50, 0, 80),
        "custo": 22.0, "cooldown": 12.0, "efeito": "MEDO", "elemento": "TREVAS",
        "duracao_fear": 2.5,
        "descricao": "Causa medo em todos prÃ³ximos"
    },
    "Necrose": {
