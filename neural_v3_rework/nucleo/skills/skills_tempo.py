"""
NEURAL FIGHTS â€” Skills: ðŸŒ€ TEMPO
===================================
Slow, haste, reset de cooldown, reversÃ£o
...
SKILLS_TEMPO = {
    ...
    "Eco Temporal": {
        ...
        "descricao": "ProjÃ©til que duplica apÃ³s 1s"
    },
    "Envelhecimento": {
    ...
    "Paradoxo": {
        ...
        "duplica_apos": 1.5,
        "descricao": "ProjÃ©til temporal lento que se duplica"
    },
    "Parar o Tempo": {
    ...
    "PrevisÃ£o": {
        ...
        "descricao": "VÃª o futuro - esquiva os prÃ³ximos 3 ataques"
    },
    "Rebobinar": {
    ...
    "Ricochete Temporal": {
        ...
        "descricao": "ProjÃ©til que salta entre alvos corrigindo o passado"
    },
    "Slow Motion": {
        ...
        "descricao": "Desacelera o tempo na Ã¡rea"
    },
}
