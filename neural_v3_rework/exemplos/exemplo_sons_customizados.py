...
def exemplo_sons_ui():
    ...
    audio.play("interface/button_hover", volume=0.3)
    
    # Ao clicar
    audio.play("interface/button_click", volume=0.5)
    
    # Menu abrindo
    audio.play("interface/menu_open", volume=0.4)
...
if __name__ == "__main__":
    print("=" * 70)
    print("EXEMPLOS DE CUSTOMIZAÃ‡ÃƒO DE ÃUDIO - NEURAL FIGHTS")
    print("=" * 70)
    ...
    print("ðŸ“– Leia os comentÃ¡rios no cÃ³digo para mais detalhes")
    print("ðŸŽµ Boa customizaÃ§Ã£o!")
