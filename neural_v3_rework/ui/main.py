...
from ui.view_ranking import TelaLeaderboard
...
class SistemaApp(tk.Tk):
    def __init__(self):
        ...
        self.frames = {}
        for F in (MenuPrincipal, TelaArmas, TelaPersonagens, TelaLuta, TelaMultiBatalha, TelaInteracoes, TelaSons, TelaWorldMap, TelaLeaderboard):
...
class MenuPrincipal(tk.Frame):
    def __init__(self, parent, controller):
        ...
        buttons = [
            ...
            ("\U0001F3C6 Rankings",           lambda: controller.show_frame("TelaLeaderboard")),
