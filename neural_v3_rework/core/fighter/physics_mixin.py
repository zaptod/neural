"""
NEURAL FIGHTS — core/fighter/physics_mixin.py  [D03/D04 Sprint 8]
==================================================================
PhysicsMixin: física de movimento, dash trail, orbes, consulta de posição.
...
from utils.config import PPM, GRAVIDADE_Z, ATRITO
...
class PhysicsMixin:
    """Mixin com física de movimento e helpers posicionais."""
    ...
    def executar_movimento(self, dt, distancia):
        ...
        # MEL-10 fix: ação desconhecida / NEUTRO → aproxima levemente
