# ðŸŽ® NEURAL FIGHTS - DocumentaÃ§Ã£o Completa do Projeto
...
â”‚
â”œâ”€â”€ ia/                       # Sistema de InteligÃªncia Artificial
â”‚   â”œâ”€â”€ brain.py              # CÃ©rebro principal (4000+ linhas) - ARQUIVO CRÃTICO
...
â”‚
â”œâ”€â”€ nucleo/                     # NÃºcleo do motor de jogo
â”‚   â”œâ”€â”€ entities.py           # Classe Lutador (1600+ linhas) - ARQUIVO CRÃTICO
...
â”‚
â”œâ”€â”€ simulacao/               # Motor de simulaÃ§Ã£o visual
â”‚   â””â”€â”€ simulacao.py          # RenderizaÃ§Ã£o Pygame (3000+ linhas) - ARQUIVO CRÃTICO
â”‚
â”œâ”€â”€ modelos/                   # Estruturas de dados
...
â”‚
â”œâ”€â”€ dados/                     # PersistÃªncia JSON
...
â”‚
â”œâ”€â”€ efeitos/                  # Efeitos visuais e sonoros
...
â”‚
â”œâ”€â”€ torneio/               # Sistema de torneio
â”‚   â””â”€â”€ tournament_mode.py    # Brackets e gestÃ£o
â”‚
â”œâ”€â”€ ferramentas/                    # Ferramentas auxiliares
...
â”‚
â””â”€â”€ utilitarios/                    # UtilitÃ¡rios
...
## âš™ï¸ CONSTANTES FÃSICAS IMPORTANTES
...
### Perfis de Hitbox (nucleo/hitbox.py)
```python
HITBOX_PROFILES = {
    "Reta": {
        "shape": "arc",
...
## ðŸŽ­ SISTEMA DE PERSONALIDADES (ia/personalities.py)
...
## ðŸ§  SISTEMA DE IA (ia/brain.py) - ARQUIVO MAIS CRÃTICO
...
## ðŸŽ¯ CLASSE LUTADOR (nucleo/entities.py)
...
class Lutador:
    ...
    buffer_areas: list       # Ãreas de efeito
...
## ðŸ’« SISTEMA DE SKILLS (nucleo/skills.py)
...
## ðŸŽ¨ RENDERIZAÃ‡ÃƒO (simulacao/simulacao.py)
...
## ðŸ”Š SISTEMA DE ÃUDIO (efeitos/audio.py)
...
## ðŸŽ¯ ARQUIVOS POR OBJETIVO

| Objetivo | Arquivo |
|----------|---------|
| Corrigir comportamento da IA | `ia/brain.py` |
| Corrigir ataque/dano | `nucleo/entities.py`, `nucleo/hitbox.py` |
| Corrigir projÃ©teis | `nucleo/combat.py` |
| Adicionar nova arma | `ferramentas/gerador_database.py`, `nucleo/hitbox.py` |
| Nova personalidade | `ia/personalities.py` |
| Nova skill | `nucleo/skills.py` |
| Corrigir visual | `simulacao/simulacao.py` |
| Novo efeito | `efeitos/` |
| Problemas de fÃ­sica | `nucleo/physics.py` |
