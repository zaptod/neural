# ðŸŽ® NEURAL FIGHTS - Contexto do Projeto para IA
...
â”‚
â”œâ”€â”€ simulacao/               # Simulador visual
...
â”‚
â”œâ”€â”€ dados/                     # Dados persistentes
...
## ðŸ“Š Classes de Personagens (16)
...
## ðŸŽ¨ RenderizaÃ§Ã£o (simulacao.py)
...
### ConfiguraÃ§Ãµes em utilitarios/config.py
```python
...
## ðŸ“š Arquivos Importantes para Modificar

| Objetivo | Arquivo |
|----------|---------|
| Adicionar nova arma | `ferramentas/gerador_database.py`, `dados/armas.json` |
| Novo tipo de arma | `nucleo/hitbox.py`, `simulacao/simulacao.py` |
| Nova personalidade | `ia/personalities.py` |
| Novo comportamento IA | `ia/brain.py` |
| Nova skill | `nucleo/skills.py` |
| Novo efeito visual | `efeitos/` |
| Nova classe | `modelos/constants.py`, `modelos/characters.py` |
