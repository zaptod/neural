...
## ðŸ† MODO TORNEIO E GERADOR DE ROSTER COMPLETO
...
### ðŸŽ¨ Interface GrÃ¡fica do Torneio (`interface/view_torneio.py`)
...
### `interface/main.py`
- Adicionado botÃ£o "ðŸ† MODO TORNEIO" no menu principal
...
## ðŸ“Š COBERTURA DE COMBINAÃ‡Ã•ES
...
2. Ou acesse pelo menu principal â†’ "ðŸ† MODO TORNEIO"
...
5. CampeÃ£o Ã© coroado no final! ðŸ†
