...
=====================================================================
Gera personagens e armas com MÃXIMA DIVERSIDADE:
- 16 Classes com estilos Ãºnicos
- 6 Raridades com diferenÃ§as visuais
- 8 Tipos de Arma com variaÃ§Ãµes de estilo
- 12 Encantamentos elementais
- 30+ Personalidades distintas
- 100+ Skills variadas
- Cores vibrantes e Ãºnicas
...
from ia.personalities import PERSONALIDADES_PRESETS, LISTA_PERSONALIDADES  # LEG-C2: fonte Ãºnica de personalidades
...
SKILLS_OFENSIVAS = {
    "FOGO": ["Bola de Fogo", "Meteoro", "LanÃ§a de Fogo", "ExplosÃ£o Nova", "Chamas do DragÃ£o", 
             "Pilar de Fogo", "Chuva de Fogo", "Cometa Flamejante", "IncineraÃ§Ã£o"],
    "GELO": ["EstilhaÃ§o de Gelo", "LanÃ§a de Gelo", "Nevasca", "Cone de Gelo", "Zero Absoluto",
             "Tempestade de Granizo", "LÃ¢mina Congelante", "Avalanche"],
    "RAIO": ["RelÃ¢mpago", "Corrente ElÃ©trica", "Tempestade", "Corrente em Cadeia", "Sobrecarga",
             "TrovÃ£o Devastador", "Pulso ElÃ©trico", "FÃºria do CÃ©u"],
    "TREVAS": ["Esfera Sombria", "LÃ¢mina de Sangue", "ExplosÃ£o NecrÃ³tica", "Drenar Vida",
               "Toque da Morte", "CorrupÃ§Ã£o", "MaldiÃ§Ã£o Fatal", "Vazio Absoluto"],
    "LUZ": ["Raio Sagrado", "ExplosÃ£o Divina", "Luz Purificadora", "Julgamento",
            "LanÃ§a Celestial", "FÃºria Divina", "Espadas de Luz"],
    "NATUREZA": ["Dardo Venenoso", "Espinhos", "FÃºria Bestial", "Garras da Terra",
                 "Tempestade de PÃ©talas", "Mordida Venenosa", "Enxame"],
    "ARCANO": ["Disparo de Mana", "MÃ­sseis Arcanos", "ExplosÃ£o Arcana", "Desintegrar",
               "LÃ¢mina Dimensional", "Caos Arcano", "Ruptura MÃ¡gica"],
    "FISICO": ["AvanÃ§o Brutal", "FÃºria GiratÃ³ria", "Impacto SÃ´nico", "Golpe do Executor",
               "Perfurar", "Golpe Devastador", "Terremoto", "Onda de Choque"],
}

SKILLS_DEFENSIVAS = {
    "GELO": ["PrisÃ£o de Gelo", "Armadura de Gelo", "Muralha Congelada"],
    "LUZ": ["Escudo Arcano", "BenÃ§Ã£o", "Aura Protetora", "Escudo Divino"],
    "ARCANO": ["Reflexo Espelhado", "DistorÃ§Ã£o Temporal", "Barreira MÃ¡gica"],
    "FISICO": ["Escudo de Combate", "Postura Defensiva", "Contra-Ataque"],
    "TREVAS": ["VÃ©u das Sombras", "AbsorÃ§Ã£o Sombria"],
    "NATUREZA": ["RegeneraÃ§Ã£o", "Casca de Pedra", "Pele de Ferro"],
}

SKILLS_UTILIDADE = {
    "RAIO": ["Teleporte RelÃ¢mpago", "Velocidade do TrovÃ£o", "Passo do Raio"],
    "TREVAS": ["Portal Sombrio", "Passo das Sombras", "Invisibilidade"],
    "LUZ": ["Cura Menor", "Cura Maior", "PurificaÃ§Ã£o", "RessurreiÃ§Ã£o"],
    "ARCANO": ["Velocidade Arcana", "Amplificador", "ClarividÃªncia", "Blink"],
    "NATUREZA": ["Camuflagem", "RaÃ­zes", "Nuvem TÃ³xica"],
    "FOGO": ["Passos Flamejantes", "ExplosÃ£o de Recuo"],
    "GELO": ["Passos GÃ©lidos", "Congelar Ãrea"],
}

# CompilaÃ§Ã£o de todas as skills
TODAS_SKILLS = []
...
# =============================================================================
# ESTILOS E VARIAÃ‡Ã•ES POR TIPO DE ARMA
# =============================================================================
...
ESTILOS_ARMA = {
    "Reta": {
        "variantes": [
            ...
            {"nome": "LanÃ§a", "cabo": (80, 120), "lamina": (30, 45), "peso": (3, 5)},
            ...
            {"nome": "MaÃ§a", "cabo": (35, 50), "lamina": (15, 25), "peso": (4, 6)},
    ...
    "Dupla": {
        "variantes": [
            {"nome": "Adagas GÃªmeas", "cabo": (10, 15), "lamina": (25, 35), "peso": (1, 2), "sep": (12, 18)},
            ...
            {"nome": "Facas TÃ¡ticas", "cabo": (8, 12), "lamina": (18, 28), "peso": (0.8, 1.5), "sep": (10, 15)},
        ],
    },
    "Corrente": {
        "variantes": [
    ...
    "Arco": {
        "variantes": [
            ...
            {"nome": "Arco Ã‰lfico", "tamanho": (55, 75), "forca": (25, 45), "flecha": (50, 65)},
        ],
    },
    "Orbital": {
        "variantes": [
            ...
            {"nome": "Orbes MÃ­sticos", "dist": (20, 28), "qtd": (3, 5), "largura": 10, "tipo": "orbe"},
            {"nome": "LÃ¢minas Orbitais", "dist": (22, 32), "qtd": (2, 4), "largura": 25, "tipo": "lamina"},
    ...
    "MÃ¡gica": {
        "variantes": [
            ...
            {"nome": "TentÃ¡culos Sombrios", "tam": (15, 25), "qtd": (2, 4), "dist": (40, 60)},
            {"nome": "Cristais Arcanos", "tam": (6, 12), "qtd": (4, 6), "dist": (25, 40)},
            {"nome": "LanÃ§as de Mana", "tam": (12, 20), "qtd": (2, 3), "dist": (45, 65)},
            {"nome": "Chamas Espirituais", "tam": (10, 16), "qtd": (3, 5), "dist": (30, 50)},
        ],
    },
    "TransformÃ¡vel": {
        "variantes": [
            {"nome": "Espada-LanÃ§a", "f1_cabo": (20, 30), "f1_lam": (50, 70), "f2_cabo": (60, 90), "f2_lam": (30, 45)},
            {"nome": "Espada ExtensÃ­vel", "f1_cabo": (15, 25), "f1_lam": (40, 55), "f2_cabo": (25, 35), "f2_lam": (70, 100)},
            {"nome": "Chicote-Espada", "f1_cabo": (20, 30), "f1_lam": (55, 75), "f2_cabo": (10, 20), "f2_lam": (100, 140)},
            {"nome": "Arco-LÃ¢minas", "f1_cabo": (30, 40), "f1_lam": (45, 60), "f2_cabo": (15, 25), "f2_lam": (35, 50)},
            {"nome": "BastÃ£o Segmentado", "f1_cabo": (40, 60), "f1_lam": (20, 30), "f2_cabo": (10, 20), "f2_lam": (80, 120)},
...
PREFIXOS_MATERIAL = [
    "AÃ§o", "Ferro", "Mithril", "Adamantino", "Obsidiana", "Cristal", "Osso", "Madeira",
    "Prata", "Ouro", "Bronze", "TitÃ¢nio", "Ã‰bano", "Marfim", "Jade", "Rubi",
]

PREFIXOS_ORIGEM = [
    "Antigo", "Ã‰lfico", "AnÃ£o", "Orc", "DemonÃ­aco", "Celestial", "Draconico",
    "Imperial", "Tribal", "Real", "Sagrado", "Profano", "Arcano", "Primal",
]

PREFIXOS_QUALIDADE = [
    "Refinado", "Brutal", "Elegante", "Sombrio", "Radiante", "Devastador",
    "Sublime", "Feroz", "MÃ­stico", "Letal", "Gracioso", "ImplacÃ¡vel",
]

SUFIXOS_ELEMENTO = {
    "Fogo": ["das Chamas", "Flamejante", "do Inferno", "da Pira", "do Magma"],
    "Gelo": ["do Gelo", "Congelante", "do Inverno", "da Nevasca", "do Frio Eterno"],
    "Raio": ["do TrovÃ£o", "ElÃ©trico", "da Tempestade", "do RelÃ¢mpago", "do CÃ©u Furioso"],
    "Trevas": ["das Sombras", "Sombrio", "do Abismo", "da EscuridÃ£o", "do Vazio"],
    "Luz": ["da Luz", "Sagrado", "Divino", "Celestial", "da Aurora"],
    "Natureza": ["da Natureza", "Selvagem", "Venenoso", "Primordial", "da Floresta"],
    "Arcano": ["Arcano", "MÃ­stico", "EtÃ©reo", "Dimensional", "do Caos"],
}

SUFIXOS_LENDARIOS = [
    "do Destruidor", "do Protetor", "do Conquistador", "do HerÃ³i",
    "da PerdiÃ§Ã£o", "da SalvaÃ§Ã£o", "do Fim", "do ComeÃ§o",
    "dos Deuses", "dos TitÃ£s", "dos DragÃµes", "dos DemÃ´nios",
    "do Apocalipse", "da CriaÃ§Ã£o", "do Destino", "da Eternidade",
    "do CampeÃ£o", "do Vencedor", "do Imortal", "do LendÃ¡rio",
]
...
TITULOS = [
    "o Bravo", "a Valente", "o Nobre", "a Justa", "o SÃ¡bio", "a SÃ¡bia",
    "o Protetor", "a Protetora", "o Invicto", "a Invicta", "o LendÃ¡rio", "a LendÃ¡ria",
    "o Cruel", "a Impiedosa", "o Sombrio", "a Sombria", "o Louco", "a Furiosa",
    "o Destruidor", "a Destruidora", "o ImplacÃ¡vel", "a ImplacÃ¡vel",
    "das Chamas", "do Gelo", "do TrovÃ£o", "das Sombras", "da Luz",
    "o Imortal", "a Eterna", "o AmaldiÃ§oado", "a AbenÃ§oada", "o Profeta", "a Vidente",
    "", "", "", "", "", "",
]

TITULOS_MASCULINOS = [
    "o Bravo", "o Nobre", "o SÃ¡bio", "o Protetor", "o Invicto", "o LendÃ¡rio",
    "o Cruel", "o Sombrio", "o Louco", "o Destruidor", "o ImplacÃ¡vel",
    "o Imortal", "o AmaldiÃ§oado", "o Profeta",
]

TITULOS_FEMININOS = [
    "a Valente", "a Justa", "a SÃ¡bia", "a Protetora", "a Invicta", "a LendÃ¡ria",
    "a Impiedosa", "a Sombria", "a Furiosa", "a Destruidora", "a ImplacÃ¡vel",
    "a Eterna", "a AbenÃ§oada", "a Vidente",
]
...
# LEG-C2: LISTA_PERSONALIDADES importada de ai.personalities (fonte Ãºnica de verdade)
...
def gerar_cor_por_raridade(raridade):
    ...
    paletas = {
        ...
        "Ã‰pico": [(160, 50, 220), (180, 80, 255), (140, 60, 200)],
        "LendÃ¡rio": [(255, 150, 0), (255, 180, 50), (255, 120, 30)],
        "MÃ­tico": [(255, 50, 150), (255, 100, 180), (220, 50, 130)],
    }
...
def _escolher_titulo_personagem(is_feminino: bool) -> str:
    if is_feminino:
...
def gerar_nome_arma(tipo, raridade, variante_nome, encantamento=None):
    """Gera nome Ãºnico para arma"""

    elemento_key = encantamento if encantamento in SUFIXOS_ELEMENTO else None
    if elemento_key and random.random() < 0.6:
        sufixo_elemental = random.choice(SUFIXOS_ELEMENTO[elemento_key])
    else:
        sufixo_elemental = None

    if raridade == "MÃ­tico":
        prefixo = random.choice(PREFIXOS_ORIGEM)
        sufixo = sufixo_elemental or random.choice(SUFIXOS_LENDARIOS)
        nome = _dedupe_nome_composto(prefixo, variante_nome, sufixo)
        return nome
    ...
    elif raridade == "Ã‰pico":
        prefixo = random.choice(PREFIXOS_QUALIDADE)
        sufixo = sufixo_elemental or random.choice(["Superior", "Excelso", "Supremo", "MagnÃ­fico"])
        nome = _dedupe_nome_composto(prefixo, variante_nome, sufixo)
        return nome
    
    elif raridade == "Raro":
        prefixo = random.choice(PREFIXOS_MATERIAL)
        nome = _dedupe_nome_composto(prefixo, variante_nome, "Refinado")
        return nome
    
    elif raridade == "Incomum":
        prefixo = random.choice(PREFIXOS_MATERIAL)
        nome = _dedupe_nome_composto(prefixo, variante_nome)
        return nome
    
    else:
        return _dedupe_nome_composto(variante_nome, "Comum")


def gerar_nome_personagem():
    """Gera nome Ãºnico para personagem"""
    ...
    titulo = _escolher_titulo_personagem(is_feminino)

    # Evita repetiÃ§Ã£o de palavra-base no nome final (ex.: "Raven das Sombras" continua,
    # mas "Sagrado ... Sagrado" e repetiÃ§Ãµes imediatas viram uma forma mais limpa).
    if titulo:
        base_nome = _tokens_base(nome)
        base_titulo = _tokens_base(titulo)
        if base_nome.intersection(base_titulo):
            titulo = random.choice(TITULOS_NEUTROS)

    if titulo:
        return _dedupe_nome_composto(nome, titulo)
    return nome


def valor_range(r):
    """Retorna valor aleatÃ³rio de uma tupla (min, max)"""
    return random.uniform(r[0], r[1])


def gerar_arma(tipo, raridade, variante_idx=None, encantamento=None, skill=None):
    """Gera uma arma com mÃ¡xima diversidade"""
    ...
    dano_base = {"Comum": 5, "Incomum": 7, "Raro": 10, "Ã‰pico": 13, "LendÃ¡rio": 17, "MÃ­tico": 22}
    dano = dano_base.get(raridade, 5) + random.uniform(-1, 2)
    
    critico = 2.0 + random.uniform(0, 3) + (1.0 if raridade in ["Ã‰pico", "LendÃ¡rio", "MÃ­tico"] else 0)
    ...
    # Campos especÃ­ficos por tipo (geometria removida â€” tamanho vem do personagem)
    if tipo == "Arremesso":
    ...
    # Valores padrÃ£o para campos gameplay
...
def gerar_personagem(classe, personalidade, arma_nome, cor=None):
    ...
    # LEG-C3: Usa mod_forca/mod_mana de CLASSES_DATA em vez de lÃ³gica duplicada por substring.
    # Cobre todas as 16 classes, inclusive Duelista, Druida, Piromante, etc.
    cd = get_class_data(classe)
    forca_bias = (cd.get("mod_forca", 1.0) - 1.0) * 4   # ex: mod_forca=1.5 â†’ +2.0
    mana_bias  = (cd.get("mod_mana",  1.0) - 1.0) * 4
    forca_base += forca_bias
    mana_base  += mana_bias
    
    # BUG-C5: clampar apÃ³s todos os bÃ´nus â€” evita valores acima de 10 (fora do range do slider)
    forca_base = max(1.0, min(10.0, forca_base))
    mana_base  = max(1.0, min(10.0, mana_base))
    
    tamanho = random.uniform(1.4, 2.2)
    # LEG-C1: campos "resistencia" e "agilidade" removidos â€” Personagem.__init__ nunca os lÃª
...
def selecionar_arma_por_classe(classe, armas):
    ...
    # "Guerreiro (ForÃ§a Bruta)" â€” a busca exata preferencias.get(classe) sempre retornava None.
    preferencias = {
        "Guerreiro": ["Reta", "TransformÃ¡vel"],
        "Mago": ["MÃ¡gica", "Orbital"],
        ...
        "CaÃ§ador": ["Arco", "Arremesso"],
        "Cavaleiro": ["Reta"],
        "Samurai": ["Reta", "TransformÃ¡vel"],
        "Feiticeiro": ["MÃ¡gica"],
        "Druida": ["MÃ¡gica", "Corrente"],
        "BÃ¡rbaro": ["Reta", "Corrente"],
        "Necromante": ["MÃ¡gica"],
    }
...
def gerar_database_diversa(num_personagens=64):
    """Gera database com MÃXIMA DIVERSIDADE"""
    ...
    for raridade in ["Ã‰pico", "LendÃ¡rio", "MÃ­tico"]:
        for tipo in LISTA_TIPOS_ARMA:
    ...
    print(f"  â†’ {len(armas)} armas geradas")
    ...
    print(f"  â†’ {len(personagens)} personagens gerados")
...
def salvar_database(armas, personagens, substituir=True):
    ...
    # LEG-C4: Notifica o AppState para recarregar, evitando dados stale em memÃ³ria
    # quando o launcher estÃ¡ aberto durante a execuÃ§Ã£o do gerador.
    try:
...
if __name__ == "__main__":
    ...
    print("\nâœ… Database gerada com sucesso!")
