...
from ai.behavior_profiles import FALLBACK_PROFILE  # MEL-07: esquiva_mult/bloqueio_mult
...
class EvasionMixin(_AIBrainMixinBase):
    ...
    def _processar_desvio_inteligente(self, dt, distancia, inimigo):
        ...
        # Com múltiplos modificadores de lentidão acumulados (ESTATICO ×1.5
        # + congelamento ×1.5 + variação), tempo_reacao podia ultrapassar 1.0
        # tornando chance_reagir negativa — o que invertia o sinal e fazia o
