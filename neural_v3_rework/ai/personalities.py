...
ESTILOS_LUTA = {
    ...
    # === NOVOS ESTILOS v15.0 — DIVERSIDADE EXPANDIDA ===
    "SKIRMISHER": {
        "descricao": "Ataques rápidos e reposicionamento constante",
        "acao_perto": "ATAQUE_RAPIDO",
        "acao_longe": "FLANQUEAR",
        "acao_medio": "POKE",
        "agressividade_base": 0.65,
    },
    "JUGGERNAUT": {
        "descricao": "Avança como trem, impossível de parar",
        "acao_perto": "ESMAGAR",
        "acao_longe": "APROXIMAR",
        "acao_medio": "PRESSIONAR",
        "agressividade_base": 0.75,
    ...
    "DUELIST": {
        "descricao": "Combate honroso um-a-um, espera aberturas",
        "acao_perto": "CONTRA_ATAQUE",
        "acao_longe": "APROXIMAR",
        "acao_medio": "COMBATE",
        "agressividade_base": 0.55,
    ...
    "HIT_TRADE": {
        "descricao": "Aceita tomar dano para causar mais",
        "acao_perto": "ESMAGAR",
        "acao_longe": "APROXIMAR",
        "acao_medio": "MATAR",
        "agressividade_base": 0.85,
    ...
    "GUERRILLA": {
        "descricao": "Ataques de distância e recuos táticos",
        "acao_perto": "RECUAR",
        "acao_longe": "POKE",
        "acao_medio": "FLANQUEAR",
        "agressividade_base": 0.55,
    ...
    "SIEGE": {
        "descricao": "Bombardeio constante de longe",
        "acao_perto": "RECUAR",
        "acao_longe": "PRESSIONAR",
        "acao_medio": "POKE",
        "agressividade_base": 0.5,
    ...
    "BLITZ": {
        "descricao": "Explosão de agressividade total, eliminar rápido",
        "acao_perto": "MATAR",
        "acao_longe": "MATAR",
        "acao_medio": "APROXIMAR",
        "agressividade_base": 0.95,
    ...
    "ROPE_A_DOPE": {
        "descricao": "Absorve golpes até o oponente cansar",
        "acao_perto": "CONTRA_ATAQUE",
        "acao_longe": "COMBATE",
        "acao_medio": "CONTRA_ATAQUE",
        "agressividade_base": 0.4,
    ...
    "WHIRLWIND": {
        "descricao": "Gira ao redor causando caos em todas direções",
        "acao_perto": "FLANQUEAR",
        "acao_longe": "APROXIMAR",
        "acao_medio": "CIRCULAR",
        "agressividade_base": 0.7,
    ...
    "BULLFIGHT": {
        "descricao": "Matador elegante, esquiva e contra-ataca",
        "acao_perto": "CONTRA_ATAQUE",
        "acao_longe": "CIRCULAR",
        "acao_medio": "FLANQUEAR",
        "agressividade_base": 0.5,
    ...
    "SNIPER": {
        "descricao": "Um tiro, um kill — máxima distância",
        "acao_perto": "FUGIR",
        "acao_longe": "POKE",
        "acao_medio": "RECUAR",
        "agressividade_base": 0.35,
    ...
    "BRAWLER": {
        "descricao": "Luta suja, vale tudo, pancadaria pura",
        "acao_perto": "MATAR",
        "acao_longe": "APROXIMAR",
        "acao_medio": "ATAQUE_RAPIDO",
        "agressividade_base": 0.8,
    },
    "TEMPLAR": {
        "descricao": "Justiça santa, avança com propósito",
        "acao_perto": "ESMAGAR",
        "acao_longe": "APROXIMAR",
        "acao_medio": "PRESSIONAR",
        "agressividade_base": 0.65,
    ...
    "ASSASSIN": {
        "descricao": "Posiciona, executa, desaparece",
        "acao_perto": "ATAQUE_RAPIDO",
        "acao_longe": "FLANQUEAR",
        "acao_medio": "FLANQUEAR",
        "agressividade_base": 0.7,
    ...
    "TURTLE": {
        "descricao": "Parede impenetrável, ultra defensivo",
        "acao_perto": "CONTRA_ATAQUE",
        "acao_longe": "COMBATE",
        "acao_medio": "COMBATE",
        "agressividade_base": 0.25,
    },
}
...
QUIRKS = {
    ...
    # === QUIRKS v15.0 (referenciados por presets) ===
    "SHOW_TIME": {
        "descricao": "Faz movimentos estilosos antes de atacar",
        "trigger": "pre_ataque",
        "efeito": "pausa_dramatica",
    },
    "HUMILHACAO": {
        "descricao": "Provoca o oponente após acertar",
        "trigger": "hit_sucesso",
        "efeito": "taunt_debuff",
    },
    "BERSERKER_MODE": {
        "descricao": "Entra em modo berserker com HP baixo",
        "trigger": "hp_baixo",
        "efeito": "damage_scaling",
    },
    "TANQUE_FINAL": {
        "descricao": "Fica extremamente resistente com HP crítico",
        "trigger": "hp_critico",
        "efeito": "resist_stun",
    },
}
...
FILOSOFIAS = {
    ...
    # === NOVAS FILOSOFIAS v15.0 ===
    "EMBOSCADA": {
        "objetivo": "Preparar armadilhas e atacar de surpresa",
        "preferencia_acao": ["FLANQUEAR", "ATAQUE_RAPIDO", "CIRCULAR"],
        "mod_agressividade": 0.15,
    },
    "DESGASTE": {
        "objetivo": "Desgastar lentamente até colapso total",
        "preferencia_acao": ["POKE", "CIRCULAR", "COMBATE"],
        "mod_agressividade": -0.05,
    },
    "BLITZ": {
        "objetivo": "Ataque relâmpago, acabar em segundos",
        "preferencia_acao": ["MATAR", "APROXIMAR", "ESMAGAR"],
        "mod_agressividade": 0.45,
    },
    "RETALIACAO": {
        "objetivo": "Punir cada erro do oponente severamente",
        "preferencia_acao": ["CONTRA_ATAQUE", "COMBATE", "MATAR"],
        "mod_agressividade": 0.1,
    },
    "ABSOLUTO": {
        "objetivo": "Vitória absoluta sem chances ao oponente",
        "preferencia_acao": ["MATAR", "PRESSIONAR", "ESMAGAR"],
        "mod_agressividade": 0.5,
    },
    "SOMBRAS": {
        "objetivo": "Agir das sombras, invisível e letal",
        "preferencia_acao": ["FLANQUEAR", "CIRCULAR", "ATAQUE_RAPIDO"],
        "mod_agressividade": 0.1,
    },
    "FORTALEZA": {
        "objetivo": "Ser uma fortaleza impenetrável",
        "preferencia_acao": ["COMBATE", "CONTRA_ATAQUE", "CIRCULAR"],
        "mod_agressividade": -0.15,
    },
    "GUERRILHA": {
        "objetivo": "Atacar e recuar, nunca dar alvo fixo",
        "preferencia_acao": ["POKE", "FLANQUEAR", "RECUAR"],
        "mod_agressividade": 0.05,
    },
    "SUPREMACIA": {
        "objetivo": "Dominar cada aspecto da luta completamente",
        "preferencia_acao": ["PRESSIONAR", "MATAR", "PRESSIONAR"],
        "mod_agressividade": 0.4,
    },
    "VINGANCA": {
        "objetivo": "Devolver cada golpe recebido com juros",
        "preferencia_acao": ["CONTRA_ATAQUE", "MATAR", "PRESSIONAR"],
        "mod_agressividade": 0.2,
    },
    "FLUXO": {
        "objetivo": "Fluir como água, adaptar constantemente",
        "preferencia_acao": ["FLANQUEAR", "COMBATE", "CIRCULAR"],
        "mod_agressividade": 0.1,
    },
    "CERCO": {
        "objetivo": "Encurralar e eliminar sem escapatória",
        "preferencia_acao": ["PRESSIONAR", "FLANQUEAR", "APROXIMAR"],
        "mod_agressividade": 0.3,
    },
}
...
INSTINTOS = {
    ...
    # === INSTINTOS v15.0 (referenciados por presets) ===
    "BURST_AGRESSIVO": {
        "descricao": "Explode em rajada de ataques rápidos",
        "trigger": "oponente_fraco",
        "chance": 0.7,
        "acao": "rage_trigger",
    },
    "CONTRA_ATAQUE_REFLEXO": {
        "descricao": "Contra-ataca automaticamente após receber dano",
        "trigger": "tomando_dano",
        "chance": 0.5,
        "acao": "instant_counter",
    },
    "PERSEGUICAO_FEROZ": {
        "descricao": "Persegue oponentes sem descanso",
        "trigger": "oponente_recuando",
        "chance": 0.8,
        "acao": "auto_chase",
    },
...
RITMOS = {
    ...
    # === RITMOS v15.0 (referenciados por presets) ===
    "REATIVO": {
        "descricao": "Reage aos movimentos do oponente",
        "fases": ["OBSERVAR", "ATACAR", "OBSERVAR", "ATACAR"],
        "duracao_fase": 3.5,
        "transicao": "natural",
    },
    "CRESCENTE": {
        "descricao": "Intensidade crescente ao longo da luta",
        "fases": ["LEVE", "MEDIO", "FORTE", "MAXIMO", "BERSERK"],
        "duracao_fase": 5.0,
        "transicao": "crescente",
    },
}
...
PERSONALIDADES_PRESETS = {
    ...
    # === NOVOS PRESETS v15.0 — PERSONALIDADES EXPANDIDAS ===
    "Gladiador": {
        "descricao": "Combate como espetáculo. Cada golpe é para a plateia.",
        "icone": "⚔️",
        "cor": (220, 180, 50),
        "tracos_fixos": ["STYLIST", "AGRESSIVO", "CONFIANTE", "EXPLOSIVO", "GLADIADOR"],
        "estilo_fixo": "BRAWLER",
        "filosofia_fixa": "ESPETACULO",
        "quirks_fixos": ["GRITO_GUERRA", "SHOW_TIME", "HUMILHACAO"],
        "instintos_fixos": ["ATAQUE_OPORTUNIDADE", "BURST_AGRESSIVO"],
        "ritmo_fixo": "CONSTANTE",
        "agressividade_mod": 0.25,
    },
    "Ninja Silencioso": {
        "descricao": "Invisível até o golpe fatal. Depois, silêncio.",
        "icone": "🌑",
        "cor": (30, 30, 60),
        "tracos_fixos": ["FANTASMA", "ASSASSINO_NATO", "FRIO", "PACIENTE", "NINJA_MENTAL"],
        "estilo_fixo": "ASSASSIN",
        "filosofia_fixa": "SOMBRAS",
        "quirks_fixos": ["SOMBRA_MORTAL", "OLHOS_DE_AGUIA", "PACIENCIA_INFINITA"],
        "instintos_fixos": ["ATAQUE_OPORTUNIDADE", "DASH_PANICO"],
        "ritmo_fixo": "PREDADOR",
        "agressividade_mod": -0.1,
    },
    "Juggernaut": {
        "descricao": "Massa imparável. Avança e esmaga tudo no caminho.",
        "icone": "🏋️",
        "cor": (100, 80, 60),
        "tracos_fixos": ["TANQUE", "IMPLACAVEL", "BLINDADO", "TOURO", "DESTRUIDOR"],
        "estilo_fixo": "JUGGERNAUT",
        "filosofia_fixa": "SUPREMACIA",
        "quirks_fixos": ["GRITO_GUERRA", "BERSERKER_MODE", "TANQUE_FINAL"],
        "instintos_fixos": ["BURST_AGRESSIVO", "CONTRA_ATAQUE_REFLEXO"],
        "ritmo_fixo": "CONSTANTE",
        "agressividade_mod": 0.3,
    },
    "Duelista Honrado": {
        "descricao": "Luta com honra. Cada golpe é uma declaração.",
        "icone": "🤺",
        "cor": (180, 200, 220),
        "tracos_fixos": ["CALCULISTA", "PACIENTE", "PREVISOR", "LEITURA_PERFEITA", "DETERMINADO"],
        "estilo_fixo": "DUELIST",
        "filosofia_fixa": "RETALIACAO",
        "quirks_fixos": ["OLHOS_DE_AGUIA", "PACIENCIA_INFINITA", "LEITURA_CORPORAL"],
        "instintos_fixos": ["CONTRA_ATAQUE_REFLEXO", "ATAQUE_OPORTUNIDADE"],
        "ritmo_fixo": "REATIVO",
        "agressividade_mod": -0.1,
    },
    "Guerrilheiro": {
        "descricao": "Ataca e desaparece. Nunca onde esperam.",
        "icone": "🌿",
        "cor": (60, 120, 40),
        "tracos_fixos": ["EVASIVO", "KITER", "OPORTUNISTA", "PRUDENTE", "SKILL_BAITER"],
        "estilo_fixo": "GUERRILLA",
        "filosofia_fixa": "GUERRILHA",
        "quirks_fixos": ["SOMBRA_MORTAL", "ADRENALINE_JUNKIE", "BURST_MODE"],
        "instintos_fixos": ["DASH_PANICO", "ADAPTACAO_RAPIDA"],
        "ritmo_fixo": "ONDAS",
        "agressividade_mod": 0.0,
    },
    "Tormenta Viva": {
        "descricao": "Fúria elemental. Ataca de todos os lados ao mesmo tempo.",
        "icone": "⛈️",
        "cor": (100, 50, 200),
        "tracos_fixos": ["EXPLOSIVO", "ERRATICO", "SELVAGEM", "RELAMPAGO", "DESTRUIDOR"],
        "estilo_fixo": "WHIRLWIND",
        "filosofia_fixa": "CAOS",
        "quirks_fixos": ["BERSERKER_MODE", "BURST_MODE", "ADRENALINE_JUNKIE"],
        "instintos_fixos": ["BURST_AGRESSIVO", "ADAPTACAO_RAPIDA"],
        "ritmo_fixo": "CAOTICO",
        "agressividade_mod": 0.3,
    },
    "Caçador Solitário": {
        "descricao": "Rastreia a presa com paciência infinita.",
        "icone": "🐺",
        "cor": (140, 100, 60),
        "tracos_fixos": ["PREDADOR", "PERSEGUIDOR", "RASTREADOR", "FRIO", "PACIENTE"],
        "estilo_fixo": "HUNTER",
        "filosofia_fixa": "CERCO",
        "quirks_fixos": ["OLHOS_DE_AGUIA", "PACIENCIA_INFINITA", "SOMBRA_MORTAL"],
        "instintos_fixos": ["ATAQUE_OPORTUNIDADE", "PERSEGUICAO_FEROZ"],
        "ritmo_fixo": "PREDADOR",
        "agressividade_mod": 0.1,
    },
    "Provocador": {
        "descricao": "Tira o oponente do sério e aproveita os erros.",
        "icone": "😏",
        "cor": (255, 200, 50),
        "tracos_fixos": ["PROVOCADOR", "SÁDICO", "CONFIANTE", "PSICOPATA", "OPORTUNISTA"],
        "estilo_fixo": "BULLFIGHT",
        "filosofia_fixa": "TORMENTO",
        "quirks_fixos": ["MIND_GAMES", "HUMILHACAO", "SHOW_TIME"],
        "instintos_fixos": ["ATAQUE_OPORTUNIDADE", "CONTRA_ATAQUE_REFLEXO"],
        "ritmo_fixo": "REATIVO",
        "agressividade_mod": 0.05,
    },
    "Sentinela": {
        "descricao": "Muralha impenetrável. Nada passa.",
        "icone": "🛡️",
        "cor": (80, 120, 180),
        "tracos_fixos": ["MURALHA", "INABALAVEL", "SENTINEL", "BLINDADO", "ABSORVEDOR"],
        "estilo_fixo": "TURTLE",
        "filosofia_fixa": "FORTALEZA",
        "quirks_fixos": ["TANQUE_FINAL", "PACIENCIA_INFINITA", "LEITURA_CORPORAL"],
        "instintos_fixos": ["CONTRA_ATAQUE_REFLEXO", "ADAPTACAO_RAPIDA"],
        "ritmo_fixo": "REATIVO",
        "agressividade_mod": -0.2,
    },
    "Dançarino Mortal": {
        "descricao": "Cada movimento é uma dança. Cada dança é um golpe.",
        "icone": "💃",
        "cor": (200, 50, 150),
        "tracos_fixos": ["DANÇARINO", "ACROBATA", "BORBOLETA", "ARTISTA_MARCIAL", "STYLIST"],
        "estilo_fixo": "GINGA",
        "filosofia_fixa": "FLUXO",
        "quirks_fixos": ["DANCA_MORTE", "SHOW_TIME", "ADRENALINE_JUNKIE"],
        "instintos_fixos": ["DASH_PANICO", "ADAPTACAO_RAPIDA"],
        "ritmo_fixo": "ONDAS",
        "agressividade_mod": 0.1,
    },
    "Kamikaze": {
        "descricao": "Sem medo da morte. A morte é o objetivo.",
        "icone": "💀",
        "cor": (200, 0, 0),
        "tracos_fixos": ["KAMIKAZE", "IMPRUDENTE", "BERSERKER", "SELVAGEM", "MASOQUISTA"],
        "estilo_fixo": "BLITZ",
        "filosofia_fixa": "ABSOLUTO",
        "quirks_fixos": ["BERSERKER_MODE", "GRITO_GUERRA", "BURST_MODE"],
        "instintos_fixos": ["BURST_AGRESSIVO", "PERSEGUICAO_FEROZ"],
        "ritmo_fixo": "CRESCENTE",
        "agressividade_mod": 0.5,
    },
    "Sniper Gélido": {
        "descricao": "Frio como gelo. Um projétil, uma vida.",
        "icone": "🎯",
        "cor": (150, 200, 255),
        "tracos_fixos": ["FRIO", "SNIPER", "CALCULISTA", "PACIENTE", "COVARDE_TATICO"],
        "estilo_fixo": "SNIPER",
        "filosofia_fixa": "DESGASTE",
        "quirks_fixos": ["OLHOS_DE_AGUIA", "PACIENCIA_INFINITA", "SOMBRA_MORTAL"],
        "instintos_fixos": ["DASH_PANICO", "ATAQUE_OPORTUNIDADE"],
        "ritmo_fixo": "PREDADOR",
        "agressividade_mod": -0.15,
    },
    "Brawler de Rua": {
        "descricao": "Sem regras, sem honra. Vale tudo.",
        "icone": "🥊",
        "cor": (180, 120, 80),
        "tracos_fixos": ["BRUTAL", "AGRESSIVO", "SELVAGEM", "COLADO", "TOURO"],
        "estilo_fixo": "BRAWLER",
        "filosofia_fixa": "PRESSAO",
        "quirks_fixos": ["GRITO_GUERRA", "BERSERKER_MODE", "ADRENALINE_JUNKIE"],
        "instintos_fixos": ["BURST_AGRESSIVO", "PERSEGUICAO_FEROZ"],
        "ritmo_fixo": "CONSTANTE",
        "agressividade_mod": 0.35,
    },
    "Matador Elegante": {
        "descricao": "Precisão cirúrgica com graça de bailarino.",
        "icone": "🌹",
        "cor": (200, 50, 80),
        "tracos_fixos": ["ARTISTA_MARCIAL", "FINALIZADOR_NATO", "TIMING_PRECISO", "STYLIST", "FRIO"],
        "estilo_fixo": "MATADOR",
        "filosofia_fixa": "EMBOSCADA",
        "quirks_fixos": ["DANCA_MORTE", "SHOW_TIME", "OLHOS_DE_AGUIA"],
        "instintos_fixos": ["ATAQUE_OPORTUNIDADE", "CONTRA_ATAQUE_REFLEXO"],
        "ritmo_fixo": "PREDADOR",
        "agressividade_mod": 0.0,
    },
    "Fortaleza Viva": {
        "descricao": "Não precisa atacar. Você se destrói nele.",
        "icone": "🏰",
        "cor": (100, 100, 120),
        "tracos_fixos": ["BLINDADO", "ABSORVEDOR", "ESPELHO", "REATIVO", "ZEN"],
        "estilo_fixo": "ROPE_A_DOPE",
        "filosofia_fixa": "VINGANCA",
        "quirks_fixos": ["TANQUE_FINAL", "PACIENCIA_INFINITA", "LEITURA_CORPORAL"],
        "instintos_fixos": ["CONTRA_ATAQUE_REFLEXO", "ADAPTACAO_RAPIDA"],
        "ritmo_fixo": "REATIVO",
        "agressividade_mod": -0.15,
