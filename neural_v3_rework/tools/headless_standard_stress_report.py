...
from ai.behavior_profiles import BEHAVIOR_PROFILES
from data.app_state import AppState, DEFAULT_MATCH_CONFIG
...
def generate_weapons(count, rng):
    ...
    for index in range(count):
        ...
        if rarity in {"Raro", "Épico", "Lendário", "Mítico"} and rng.random() < 0.55:
