...
TITULOS_MASCULINOS = [
    "o Bravo", "o Nobre", "o Sábio", "o Protetor", "o Invicto", "o Lendário",
    "o Cruel", "o Sombrio", "o Louco", "o Destruidor", "o Implacável",
    "o Imortal", "o Amaldiçoado", "o Profeta",
]

TITULOS_FEMININOS = [
    "a Valente", "a Justa", "a Sábia", "a Protetora", "a Invicta", "a Lendária",
    "a Impiedosa", "a Sombria", "a Furiosa", "a Destruidora", "a Implacável",
    "a Eterna", "a Abençoada", "a Vidente",
]
...
def gerar_nome_arma(tipo, raridade, variante_nome, encantamento=None):
    ...
    if raridade == "Mítico":
        ...
        sufixo = sufixo_elemental or random.choice(["Superior", "Excelso", "Supremo", "Magnífico"])
        nome = _dedupe_nome_composto(prefixo, variante_nome, sufixo)
        return nome
...
def gerar_nome_personagem():
    ...
    # Evita repetição de palavra-base no nome final (ex.: "Raven das Sombras" continua,
    # mas "Sagrado ... Sagrado" e repetições imediatas viram uma forma mais limpa).
    if titulo:
