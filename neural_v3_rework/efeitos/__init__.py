"""
NEURAL FIGHTS - MÃ³dulo Effects
Sistema de efeitos visuais, partÃ­culas e cÃ¢mera.
"""
...
# === NOVO: Sistema de AnimaÃ§Ã£o de Movimento v8.0 ===
...
# === NOVO: Sistema de AnimaÃ§Ã£o de Ataque v8.0 IMPACT EDITION ===
from .attack import (
...
# === NOVO: Sistema de AnimaÃ§Ã£o de Armas v2.0 ===
...
# v11.0 - Efeitos de Magia DramÃ¡ticos
